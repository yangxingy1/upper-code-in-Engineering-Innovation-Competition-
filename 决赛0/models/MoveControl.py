...
class MoveControl(object):
    ...
    def __send_serial_msg(self, mode, x_dis=None, y_dis=None, angel=None):
        ...
        elif mode == Mode.down_3:
            self.send_buffer[1] = mode.value
        
        elif mode == Mode.back_home:
            self.send_buffer[1] = mode.value
    ...
    def putBlockToRaw(self):
        self.__send_serial_msg(mode=Mode.down_3)
    ...
    def back_home(self):
        self.__send_serial_msg(mode=Mode.back_home)
