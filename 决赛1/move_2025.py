...
class ComRun:
    ...
    def catch(self, task_color_list):
        ...
        # 排除出第三次颜色
        color_left = list(set(task_color_list) - set(color_list_real))
        ...
        for i, color in enumerate(task_color_list):
            ...
            if i == 2:
                ...
                self.moveControl.move_while_adjusting_height(mix_mode=MixMode.rawAreaLeave,
                                                             move_dis=-(dis2red + red2corner + 0.10))
    ...
    def run(self):
        ...
        self.moveControl.set_distance(x=1.45)
        time.sleep(2)
        ...
        self.moveControl.set_distance(x=1.85)
